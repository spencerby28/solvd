...
<section
  ...
  class={cn(
    "mx-auto w-full bg-gradient-to-b from-green-600 via-green-500 to-yellow-400 relative rounded-2xl overflow-hidden",
    containerClass
  )}
>
  <div
    class="relative h-full [background-image:radial-gradient(88%_100%_at_top,rgba(255,255,255,0.1),rgba(255,255,255,0))] sm:mx-0 sm:rounded-2xl overflow-hidden"
